    ...
    return (
        <div className="d-flex">
            ...
            <div className="flex-grow-1 p-4">
                ...
                <h2 className="mb-3">{t.createTitle}</h2>
                {error && (
                ...
                <div className="card">
                    <div className="card-body">
                        <form onSubmit={handleSubmit}>
                                ...
                                {galleryPreviews.length > 0 && (
                                    <div className="mt-2 d-flex flex-wrap gap-2">
                                        {galleryPreviews.map((preview, index) => (
                                            <img key={index} src={preview} alt={`Gallery Preview ${index + 1}`} style={{ maxWidth: '100px', maxHeight: '100px' }} />
                                        ))}
                                    </div>
                                )}
                            </div>
                            ...
                            <button type="submit" className="btn btn-success">{t.createButton}</button>
